...
const Projects = () => {
  return (
    <div id="project"
      ...
      {/* card design 1 */}
      <div className="grid grid-cols-1 gap-5 p-10 my-10 shadow-2xl lg:grid-cols-3">
        <div className=" col-md-4" data-aos="fade-right">
          ...
          <div className="transition border border-blue-200 rounded hover:shadow-2xl card " >
            ...
            <div className="flex items-center justify-center gap-2 m-auto mt-3 ">
              ...
              <span className="size-7 rounded-3xl"><img className="size-7 rounded-3xl" src={ex} alt="" /></span>
              <span className="size-4 rounded-3xl"><img className="size-4 rounded-3xl" src={react01} alt="" /></span>
              <span className="size-7 rounded-3xl"><img className="size-7 rounded-3xl" src={mongo} alt="" /></span>
            </div>
            <div className="text-center card-body">
              <div className="flex flex-col items-center justify-center gap-3 m-auto ad-title">
                ...
                <a href="https://tourist-guide-3bd84.firebaseapp.com/" className="relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden group rounded-md">
                  ...
                  <span className="relative flex items-center justify-center gap-3 px-6 py-3 transition-all ease-out bg-gray-900 rounded-md group-hover:bg-opacity-0 duration-400">
                    <span className="relative text-white ">view </span><FaArrowTrendUp className="text-white" />
          ...
          <div className="transition border border-blue-200 rounded hover:shadow-2xl card " >
            ...
            <div className="text-center card-body">
              <div className="flex flex-col items-center justify-center gap-3 m-auto ad-title ">
                ...
                <a href="https://food-king-747d6.web.app" className="relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden group rounded-md">
                  <span className="w-full h-full bg-gradient-to-br from-[#ff8a05] via-[#ff5478] to-[#ff00c6] group-hover:from-[#ff00c6] group-hover:via-[#ff5478] group-hover:to-[#ff8a05] absolute"></span>
                  <span className="relative flex items-center justify-center gap-3 px-6 py-3 transition-all ease-out bg-gray-900 rounded-md group-hover:bg-opacity-0 duration-400">
                    <span className="relative text-white ">view </span><FaArrowTrendUp className="text-white" />
                  </span>
