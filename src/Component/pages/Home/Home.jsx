...
const Home = () => {
  return (
    <div
      className="flex flex-col-reverse items-center justify-between gap-10 py-20 text-white lg:flex-row lg:gap-20"
      id="home"
    >
      <div className="container flex-1 px-6 mx-auto text-center lg:px-10 lg:text-left">
        <div className="flex flex-col items-center px-10 lg:items-start ">
          ...
          <div className="pl-6 ml-0 mr-0 border-l-2 lg:pl-10 lg:ml-2 lg:mr-2">
            ...
            <h1
              className="text-xl font-bold uppercase md:text-3xl lg:text-4xl"
              data-aos="fade-right"
            >
              <Typewriter
                options={{
          ...
          <div className="flex flex-col items-center gap-3 pt-5 lg:items-start md:flex-row">
            ...
            <a
              href="https://drive.google.com/file/d/1pEtx8oGtHzHt4FTZ5KB8LEAOI8QPPlAJ/view?usp=sharing"
              className="relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden group rounded-md"
            >
      ...
      <div className="flex items-center justify-center flex-1">
        <div className="w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] lg:w-[250px] lg:h-[250px]  border-2 border-white rounded-full overflow-hidden">
          <img
